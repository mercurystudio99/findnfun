...
class _EditActivityScreenState extends State<EditActivityScreen> {
  ...
  Map<String, dynamic> activity_images = {
    "image_0": "",
    "image_1": "",
    "image_2": ""
  };
  ...
  Future<void> _getCurrentUserData() async {
    ...
    _descriptionController.text = widget.appData['ap_bio'];
    setState(() {
      distanceValue =
          widget.appData['ap_settings']['ap_max_distance'].toDouble();
      maxDistance = freeAcctDistance.toDouble();
      profileActive = widget.appData['ap_status'] == "active" ? true : false;
      activity_images = widget.appData['ap_gallery'];

      _currentRangeValues = RangeValues(
          widget.appData['ap_settings']['ap_min_age'].toDouble(),
          widget.appData['ap_settings']['ap_max_age'].toDouble());
    });
  }
