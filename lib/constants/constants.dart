...
///
const String APP_NAME = "FindNFun";
...
//
const String ANDROID_MAPS_API_KEY = "AIzaSyDS7Thj6-wyfuPU_SyA2MWYynQJEh1rGe4";
const String IOS_MAPS_API_KEY = "YOUR IOS API KEY";
//
// GOOGLE ADMOB INTERSTITIAL IDS
//
// For Android Platform
const String ANDROID_INTERSTITIAL_ID = "ca-app-pub-6171354110400456/3713970336";
// For IOS Platform
...
///
const List<Locale> SUPPORTED_LOCALES = [Locale('en'), Locale('es')];
...
const String FREE_MAX_ACTIVITIES = "max_activities";
