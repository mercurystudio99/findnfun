...
class FlagStoryDialog extends StatefulWidget {
  // Variables
  final Story story;
  final bool isStoryProfile;

  const FlagStoryDialog({
    Key? key, 
    required this.story, 
    this.isStoryProfile = false}) : super(key: key);

  @override
  _FlagStoryDialogState createState() => _FlagStoryDialogState();
}

class _FlagStoryDialogState extends State<FlagStoryDialog> {
  // Variables
                  ...
                  TextButton(
                    ...
                    onPressed: _selectedFlagOption == ''
                        ...
                        : () async {
                            ...
                            await _storiesApi
                                .flagStory(
                                    isStoryProfile: widget.isStoryProfile,
                                    reason: _selectedFlagOption,
                                    story: widget.story)
                                .catchError((e) {
                              // Debug
                              debugPrint('flagStory() -> error: $e');
                            });

                            // Get message
                            final String message = _i18n.translate(
                                "thank_you_the_story_will_be_reviewed");
