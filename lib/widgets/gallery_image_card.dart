...
class GalleryImageCard extends StatelessWidget {
            ...
            Positioned(
              child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    if (imageUrl == null) {
                      /// Add or update image
                      _selectImage(context, userModel);
                    } else {
                      /// Delete image from gallery
                      _deleteGalleryImage(context, userModel);
                    }
                  }),
              right: 8,
              bottom: 5,
  ...
  void _selectImage(BuildContext context, UserModel userModel) async {
    /// Initialization
  ...
  /// Delete image from gallery
  void _deleteGalleryImage(BuildContext context, UserModel userModel) async {
    /// Initialization
    final i18n = AppLocalizations.of(context);
    final pr = ProgressDialog(context, isDismissible: false);
