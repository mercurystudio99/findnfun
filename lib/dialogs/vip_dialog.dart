                ...
                children: <Widget>[
                  ...
                  ListTile(
                    leading: CircleAvatar(
                      radius: 20,
                      backgroundColor: Theme.of(context).primaryColor,
                      child: const SvgIcon("assets/icons/video_icon.svg",
                          color: Colors.white),
                    ),
                    title: Text(i18n.translate("video_call_and_voice_call"),
                        style: const TextStyle(fontSize: 18)),
                    subtitle: Text(i18n.translate(
                        "see_your_match_in_the_real_world_by_using_a_video_call_feature")),
                  ),
